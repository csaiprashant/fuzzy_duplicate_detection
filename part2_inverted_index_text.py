...
index = sc.wholeTextFiles('/cosc6339_hw2/gutenberg-500/', minPartitions=64)
...
inv_index = ntf_index.flatMap(lambda(file_name, words_with_ntf) : [(word[0], [(file_name, word[1])]) for word in words_with_ntf]).reduceByKey(lambda a, b: a + b, numPartitions=64)
ntf_index.unpersist()
# Save the inverted index
inv_index.saveAsTextFile("/bigd34/index")
